...
def apply_harmony(
    ...
    so the corrected matrix always comes back as ``(n_samples, n_features)``
    regardless of which harmonypy version is installed.
    """
    ...
    try:
        ...
        return _harmony_oriented(ho, X.shape[0]), True
